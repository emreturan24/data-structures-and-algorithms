...
public class CapacityService {
    ...
    public List<Baggage> tryAssignWaitingBaggage(Flight nextFlight) {
        ...
        List<Baggage> assigned = waitingQueue.drainForFlight(
    ...
    public Baggage dequeueWaiting() {
        return waitingQueue.dequeue();
    }

    // ==================== SORGULAR ====================

    public List<Baggage> getAllWaiting()          { return waitingQueue.getAllWaiting(); }
